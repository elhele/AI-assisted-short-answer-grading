...
The similarity measures were tested separately and then combined. Weight of each measure was determined by linear regression.\\
...
Zbontar & 2012 & \begin{tabular}[l]{@{}c@{}} bag-of-words and character-n-grams+\\+ RR, SVM-RBF, GMB, KNN, RF \end{tabular}  &  73.892\% \\ \hline
RfU & 2013 & \begin{tabular}[l]{@{}c@{}} BLEU, ROUGE, answer length, coherence,\\common with topic formulation n-grams +\\+logistic regression  \end{tabular}  &  52\%-65\% \\ \hline
SemEval & 2013 &  \begin{tabular}[x]{@{}c@{}} Dzikovska team ~\cite{Burrows}: word overlap,\\Lesk (see Mohler's paper description),\\cosine distance, F1(WordNet relation)+\\+ C4.5 decision tree;\\ ETS team ~\cite{Heilman}: lexical similarity,\\n-grams, BLEU, PERP + logistic regression  \end{tabular}  & 62\%-70\% \\ \hline
